...
- When you level up
  ...
  - **Multi-attack** - Doesn't stack
  - **Channel divinity** - You get more options, but not more uses
...
- **Warlocks** - You can use **pact magic** slots for non-warlock spells, and regular spell slots for pact magic
